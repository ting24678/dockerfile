...
Dockerfile 地址 : https://github.com/ting24678/dockerfile/tree/main/cicd-tools
...
docker run -it --rm \
  ...
  -v ~/.kube:/root/.kube \
  ting24678/cicd-tools:v1 /bin/bash
```
...
docker run -it --rm \
  ...
  -v ~/.kube:/root/.kube \
  -v ~/.aws:/root/.aws \
  ting24678/cicd-tools:v1-aws /bin/bash
```
...
podman run -it --rm \
  ...
  -v ~/.kube:/root/.kube \
  ting24678/cicd-tools:v1-podman /bin/bash
```
